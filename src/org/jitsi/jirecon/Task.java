               ...
               Runnable
{
    ...
    public void init(String mucJid, XMPPConnection connection, String savingDir)
    {
        ...
        //wen: disabled jingleSession listener, no effect for recording. 
...
//        transport.free();
     ...
     * {@inheritDoc}
     */
    //wen: add a participant and it seems doesn't work, this call may be never used...
    //updated: fireEvent is in SessionMgr(have call) and RecorderStream(no one call it)
